...
export const IssueCsvImportModal = observer(function IssueCsvImportModal(props: Props) {
  ...
  const handleDownloadSample = () => {
    csvDownload(
      [
        ["Name", "Description", "Priority", "State", "Labels", "Assignees", "Start Date", "Target Date"],
        ["Fix login bug", "Users cannot login", "high", "Todo", "Bug", "user@example.com", "2026-01-01", "2026-01-15"],
        [
          "Update docs",
